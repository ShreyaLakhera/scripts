...
parameters_LN = ['dxdt', 'v', 'mk', 'mca', 'hca', 'nk', 'CA_DRIVE', 'I_KCA', 'I_CA', 'I_K_LN', 'I_LEAK', 'I_KLEAK','I_LEAK_LN', 'I_KLEAK_LN', 'iext', 'last_spike', 'ampNoise', 'I_Noise']
parameters_PN = ['dxdt', 'v', 'm', 'h', 'n', 'ma', 'ha', 'I_NA', 'I_K', 'I_A', 'I_LEAK', 'I_KLEAK', 'I_LEAK_LN', 'I_KLEAK_LN','I_ext', 'last_spike', 'ampNoise', 'I_Noise']
